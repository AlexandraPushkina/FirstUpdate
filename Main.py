...
class Helper:
    ...
    def __init__(self, root_out):
        ...
        #create button in object - button
        self.btnInsert = Button(self.root, 
                                image=self.btn0, 
                                highlightthickness=1,
                                bd = 0,
                                activebackground='#151d39', 
                                background='#151d39', 
                                command=handle_click_btnInsert
                                )  
        self.btnInsert.pack()             #show button

        self.btnRandom = Button(self.root, 
                                image=self.btn1, 
                                highlightthickness=1,
                                bd=0,
                                activebackground='#151d39', 
        ...
        self. btnHistory = Button(self.root,
                                  image=self.btn2, 
                                  highlightthickness=1,
                                  bd=0,
                                  activebackground='#151d39', 
