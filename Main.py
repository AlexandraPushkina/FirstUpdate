...
bg = PhotoImage(file="idea/pictures/background.png")  #open picture
leftside = PhotoImage(file = "idea/pictures/leftside.png")
...
btn0 = PhotoImage(file = "idea/pictures/inserttext.png")      #open pictures for buttons
btn0 = btn0.subsample(3,3)                                #reduce their size

btn1 = PhotoImage(file = "idea/pictures/randomtext.png")
btn1 = btn1.subsample(3,3)

btn2 = PhotoImage(file = "idea/pictures/history.png")
btn2 = btn2.subsample(3,3)

btn3 = PhotoImage(file = "idea/pictures/home.png")
...
btnHome.pack()
btnHome.bind('<Button-1>', handle_click_btnHome) # Run handle on click
