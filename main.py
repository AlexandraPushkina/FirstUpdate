...
if __name__ == '__main__':
    ...
    btnInsert = Button(root, image=btn0, highlightthickness=1, bd=0, activebackground='#151d39',
                       background='#151d39')  # create button in object - button
    ...
    btnRandom.pack()
    btnRandom.bind('<Button-1>', partial(handle_click_btnRandom))
    ...
    btnHome = Button(root, width=500 / 3, height=200 / 3, image=btn3, highlightthickness=1, bd=0,
                     activebackground='#151d39', background='#151d39')
    btnHome.pack()
